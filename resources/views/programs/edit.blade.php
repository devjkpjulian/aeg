        ...
        <div class="max-w-md mx-auto border-4 shadow-xl bg-white/90 border-amber-300/50 sm:rounded-lg sm:p-6 lg:p-6">
                ...
                <form method="POST" action="{{ route('programs.update',$course->id) }}">
                    ...
                    <div class="mt-4">
                        ...
                        <x-jet-input id="name" class="block w-full mt-1" type="text" name="name" value="{{ $course->name }}" required autofocus autocomplete="name" />
                    </div>

                    <div class="mt-4">
                        <x-jet-label for="abbreviation" value="{{ __('Abbreviation') }}" />
                        <x-jet-input id="abbreviation" class="block w-full mt-1" type="text" name="abbreviation" value="{{ $course->abbreviation }}" required autofocus />
                    </div>
